...
(function () {
  ...
  function wireDailyMissionChecklist() {
    var items = document.querySelectorAll('[data-daily-mission-checklist] [data-mission-step]');
    ...
    items.forEach(function (item, index) {
      ...
      var isStoredDone = api.isActionChecked(index);
      item.classList.toggle('done', isStoredDone);
      syncDailyMissionChecklistItem(item, isStoredDone);

      var observer = new MutationObserver(function () {
        var isDone = item.classList.contains('done');
        syncDailyMissionChecklistItem(item, isDone);
        api.setActionChecked(index, isDone);
      });
