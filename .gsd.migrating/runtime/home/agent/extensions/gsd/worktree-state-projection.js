 ...
 */
export function _projectRootToWorktreeImpl(projectRoot, worktreePath_, milestoneId) {
 ...
 * the caller.
 */
export function _projectWorktreeToRootImpl(worktreePath_, projectRoot, milestoneId) {
    if (!worktreePath_ || !projectRoot || worktreePath_ === projectRoot)
        return;
    if (!milestoneId)
        return;
 ...
 */
export function _finalizeProjectionForMergeImpl(mainBasePath, worktreePath, milestoneId) {
