 ...
 */
export function diffWorktreeAll(basePath, name, branchOverride) {
    basePath = normalizeBasePathForWorktreeOps(basePath);
 ...
 */
export function diffWorktreeNumstat(basePath, name, branchOverride) {
    basePath = normalizeBasePathForWorktreeOps(basePath);
    const branch = branchOverride ?? worktreeBranchName(name);
    const mainBranch = nativeDetectMainBranch(basePath);
 ...
 */
export function mergeWorktreeToMain(basePath, name, commitMessage, branchOverride) {
    basePath = normalizeBasePathForWorktreeOps(basePath);
    const branch = branchOverride ?? worktreeBranchName(name);
    const mainBranch = nativeDetectMainBranch(basePath);
