...
export function applyMigrationV3Memories(db) {
    db.exec(`
...
export function applyMigrationV4DecisionMadeBy(db) {
...
export function applyMigrationV5HierarchyTables(db) {
    db.exec(`
...
export function applyMigrationV6SliceSummaries(db) {
...
export function applyMigrationV7Dependencies(db) {
...
export function applyMigrationV8PlanningFields(db) {
...
export function applyMigrationV9Ordering(db) {
...
export function applyMigrationV12QualityGates(db) {
    db.exec(`
...
export function applyMigrationV13HotPathIndexes(db, ensureVerificationEvidenceDedupIndex) {
...
export function applyMigrationV14SliceDependencies(db) {
    db.exec(`
...
export function applyMigrationV15AuditTables(db) {
    db.exec(`
...
export function applyMigrationV16EscalationSource(db) {
...
export function applyMigrationV17TaskEscalation(db) {
...
export function applyMigrationV18MemorySources(db) {
...
export function applyMigrationV19MemoryFts(db, hooks) {
    db.exec(`
...
export function applyMigrationV20MemoryRelations(db) {
    db.exec(`
...
export function applyMigrationV21StructuredMemories(db) {
