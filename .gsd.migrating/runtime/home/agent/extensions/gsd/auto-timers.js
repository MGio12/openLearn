...
export function resolveUnitSupervisionTimeouts(unitType, supervisor, timeoutScale) {
...
export function startUnitSupervision(sctx) {
    ...
    const timeoutScale = estimateMinutes && estimateMinutes > 0
        ...
        : 1;
    const supervisionTimeouts = resolveUnitSupervisionTimeouts(unitType, supervisor, timeoutScale);
