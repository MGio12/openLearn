...
| D004 | M001 planning | design | Visual direction for M001 | Use a carnet de prépa vivant visual language and avoid generic SaaS/AI-slop aesthetics. | The user's conversion thesis depends on intimacy, specificity, and craft details that make the low-price offer feel personal and valuable. | Yes | collaborative |
